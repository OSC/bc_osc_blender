...
%global repo_name bc_osc_blender
%global app_name bc_osc_blender
...
Summary:  Batch Connect - OSC Blender
...
%description
An interactive app designed for OSC OnDemand that launches a Blender in a VNC session.
